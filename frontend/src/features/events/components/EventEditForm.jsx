...
import "./EventForm.css"; // reuse your themed date styles
...
export default function EventEditForm({
  ...
  // Prefill when initialEvent arrives/changes
  useEffect(() => {
  ...
  async function submit(e) {
    ...
    try {
      ...
      onError?.(ex?.message || "Failed to update event.");
    } finally {
  ...
  return (
    <form onSubmit={submit} className="events-form">
      ...
      <FormTextarea
        label="Description"
        placeholder="Updated dates - Ramadan starts one day earlier"
