        ...
        >
          ...
          >
            <svg
              ...
              fill="none"
              style={{
                transform: pageDir === "rtl" ? "scaleX(-1)" : "none",
              }}
            >
              <path
                ...
                selectedProducts.map((p) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      disabled={busy}
                      aria-label={t("mergeModal.removeProduct")}
                      title={t("mergeModal.removeProduct")}
                      style={{
                        fontSize: 14,
                        lineHeight: 1,
                        color: "var(--color-text-secondary)",
